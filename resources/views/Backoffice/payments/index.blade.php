    ...
    <div class="content me-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mt-4">
            <div class="pagination-info mb-3 mb-md-0">
                Affichage de <span class="fw-semibold">{{ $payments->firstItem() }}</span> à <span class="fw-semibold">{{ $payments->lastItem() }}</span> 
                sur <span class="fw-semibold">{{ $payments->total() }}</span> paiements
            </div>
                ...
                @if ($payments->hasPages())
                    <nav aria-label="Navigation des pages">
                        <ul class="pagination justify-content-center mb-0">
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $payments->previousPageUrl() }}" rel="prev" aria-label="Précédent">
                                        <i class="ti ti-chevron-left"></i>
                                    </a>
                                </li>
                            @endif
                            ...
                            @php
                                ...
                                if ($start > 1) {
                                    echo '<li class="page-item"><a class="page-link" href="' . $payments->url(1) . '">1</a></li>';
                                    if ($start > 2) {
                                ...
                                for ($i = $start; $i <= $end; $i++) {
                                    $active = $i == $payments->currentPage() ? 'active' : '';
                                    echo '<li class="page-item ' . $active . '"><a class="page-link" href="' . $payments->url($i) . '">' . $i . '</a></li>';
                                }
                                ...
                                if ($end < $payments->lastPage()) {
                                    ...
                                    echo '<li class="page-item"><a class="page-link" href="' . $payments->url($payments->lastPage()) . '">' . $payments->lastPage() . '</a></li>';
                                }
                            @endphp
                            ...
                            @if ($payments->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ $payments->nextPageUrl() }}" rel="next" aria-label="Suivant">
